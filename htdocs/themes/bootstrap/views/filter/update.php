...
$this->pageTitle=Yii::app()->name . ' - Update Filter';
...
<p>Please edit the filter <?php echo $_GET['filter'] ?>. You can add multiple rules to match subjects, addresses, or other parts of the message. You can then add multiple actions to take on a message such as to deliver the message to a different address and then discard it.</p>
...
<script type="text/javascript">
    var filterValues = <?php echo json_encode($filter); ?>;
</script>